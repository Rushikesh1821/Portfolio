...
const socialLinks = [
  {
    id: 'github',
    icon: FiGithub,
    url: 'https://github.com/rushikesh',
    label: 'GitHub',
  },
  {
    id: 'linkedin',
    icon: FiLinkedin,
    url: 'https://linkedin.com/in/rushikesh',
    label: 'LinkedIn',
  },
  {
    id: 'twitter',
    icon: FiTwitter,
    url: 'https://twitter.com/rushikesh',
    label: 'Twitter',
  },
  {
    id: 'email',
    icon: FiMail,
    url: 'mailto:rushikesh@example.com',
    label: 'Email',
  },
];
        ...
        <div className="flex flex-col items-center space-y-8">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-dark-500 text-xs">
              © {currentYear} Rushikesh. All rights reserved.
            </p>
          </div>
        </div>
      </div>
